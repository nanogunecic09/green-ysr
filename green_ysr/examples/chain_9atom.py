...
chain_sim = gr.lattice(type='1D',N=2,alpha=6.3,direction=(1,2),mode=1,U=0,spiral=0,m=18.7,pf = 0.28) # load the simulator
...
chain_sim = gr.load_obj('sim_type1D_N9_direction(1, 2)_pitch_x6.3_mode1_U0_alpha0.03_angles0')
